...
The key challenge was to add a file that exceeded GitHub's large file cap of 100 MB.  A large file was created in R and saved as an `.rds` file.  The file was then added to the repository.  A large matrix was created and saved.  The file size was `r file.info("./large_file.rds")$size `.
